...
class WoodBlockTiny : public GameObject2D, public AwakeListenerBase
{
private:
	int hitPoints;
public:
	WoodBlockTiny(float x, float y, float rot);
	WoodBlockTiny() = default;
	~WoodBlockTiny() = default;
	WoodBlockTiny(const WoodBlockTiny&) = delete;
	WoodBlockTiny& operator=(const WoodBlockTiny&) = delete;
