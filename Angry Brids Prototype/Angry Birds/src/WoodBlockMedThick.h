...
class WoodBlockMedThick : public GameObject2D, public AwakeListenerBase
{
private:
	int hitPoints;
public:
	WoodBlockMedThick(float x, float y, float rot);
	WoodBlockMedThick() = default;
	~WoodBlockMedThick() = default;
	WoodBlockMedThick(const WoodBlockMedThick&) = delete;
	WoodBlockMedThick& operator=(const WoodBlockMedThick&) = delete;
