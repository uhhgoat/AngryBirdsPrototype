...
class StoneBlockShort : public GameObject2D, public AwakeListenerBase
{
private:
	int hitPoints;
public:
	StoneBlockShort(float x, float y, float rot);
	StoneBlockShort() = default;
	~StoneBlockShort() = default;
	StoneBlockShort(const StoneBlockShort&) = delete;
	StoneBlockShort& operator=(const StoneBlockShort&) = delete;
