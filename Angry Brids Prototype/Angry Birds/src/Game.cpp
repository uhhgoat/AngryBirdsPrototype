...
void Game::LoadContent()
{
	...
	slingShot = new SlingShot(100, 365, 0.0f);
...
void Game::Update(float currentTime)
{
	...
	//PHASE 2.5: Update SlingShot (Player)
		slingShot->Update();
		//testLevel->Update();
...
{
	CleanSortBuckets(GameObjectName::EffectsGroup);
	CleanSortBuckets(GameObjectName::FrontSling);
	CleanSortBuckets(GameObjectName::MainGroup);
	CleanSortBuckets(GameObjectName::Structure);
	CleanSortBuckets(GameObjectName::Birds);
	CleanSortBuckets(GameObjectName::BackSling);
	CleanSortBuckets(GameObjectName::Background);
...
void Game::CleanSortBuckets(GameObjectName::Name name)
{
	GameObject *pObj;
	GameObject *pObjNext;

	GameSortBucket* pSortBktCln = (GameSortBucket*)GameObjectMan::Find(name);

	pObj = (GameObject *)pSortBktCln->getChild();
	while (pObj != 0)
	{
