...
class WoodBlockLong : public GameObject2D, public AwakeListenerBase
{
private:
	int hitPoints;
public:
	...
	~WoodBlockLong() = default;
	WoodBlockLong(const WoodBlockLong&) = delete;
	WoodBlockLong& operator=(const WoodBlockLong&) = delete;
