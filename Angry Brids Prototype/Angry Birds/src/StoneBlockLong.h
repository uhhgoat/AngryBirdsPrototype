...
class StoneBlockLong : public GameObject2D, public AwakeListenerBase
{
private:
	int hitPoints;
public:
	StoneBlockLong(float x, float y, float rot);
	StoneBlockLong() = default;
	~StoneBlockLong() = default;
	StoneBlockLong(const StoneBlockLong&) = delete;
	StoneBlockLong& operator=(const StoneBlockLong&) = delete;
