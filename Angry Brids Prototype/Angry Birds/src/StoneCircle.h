...
class StoneCircle : public GameObject2D, public AwakeListenerBase
{
private:
	int hitPoints;
public:
	StoneCircle(float x, float y, float rot);
	StoneCircle() = default;
	~StoneCircle() = default;
	StoneCircle(const StoneCircle&) = delete;
	StoneCircle& operator=(const StoneCircle&) = delete;
