...
class GlassBlockMed : public GameObject2D, public AwakeListenerBase
{
private:
	int hitPoints;
public:
	...
	~GlassBlockMed() = default;
	GlassBlockMed(const GlassBlockMed&) = delete;
	GlassBlockMed& operator=(const GlassBlockMed&) = delete;
