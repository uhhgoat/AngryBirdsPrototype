...
class GlassBlockTinySquare : public GameObject2D, public AwakeListenerBase
{
private:
	int hitPoints;
public:
	GlassBlockTinySquare(float x, float y, float rot);
	GlassBlockTinySquare() = default;
	~GlassBlockTinySquare() = default;
	GlassBlockTinySquare(const GlassBlockTinySquare&) = delete;
	GlassBlockTinySquare& operator=(const GlassBlockTinySquare&) = delete;
