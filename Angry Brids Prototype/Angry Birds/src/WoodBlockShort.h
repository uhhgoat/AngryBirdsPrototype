...
class WoodBlockShort : public GameObject2D, public AwakeListenerBase
{
private:
	int hitPoints;
public:
	...
	~WoodBlockShort() = default;
	WoodBlockShort(const WoodBlockShort&) = delete;
	WoodBlockShort& operator=(const WoodBlockShort&) = delete;
