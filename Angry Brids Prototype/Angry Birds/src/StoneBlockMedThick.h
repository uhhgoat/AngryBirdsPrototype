...
class StoneBlockMedThick : public GameObject2D, public AwakeListenerBase
{
private:
	int hitPoints;
public:
	StoneBlockMedThick(float x, float y, float rot);
	StoneBlockMedThick() = default;
	~StoneBlockMedThick() = default;
	StoneBlockMedThick(const StoneBlockMedThick&) = delete;
	StoneBlockMedThick& operator=(const StoneBlockMedThick&) = delete;
