...
class StoneBlockMed : public GameObject2D, public AwakeListenerBase
{
private:
	int hitPoints;
public:
	StoneBlockMed(float x, float y, float rot);
	StoneBlockMed() = default;
	~StoneBlockMed() = default;
	StoneBlockMed(const StoneBlockMed&) = delete;
	StoneBlockMed& operator=(const StoneBlockMed&) = delete;
