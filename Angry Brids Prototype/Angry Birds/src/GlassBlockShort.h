...
class GlassBlockShort : public GameObject2D, public AwakeListenerBase
{
private:
	int hitPoints;
public:
	GlassBlockShort(float x, float y, float rot);
	GlassBlockShort() = default;
	~GlassBlockShort() = default;
	GlassBlockShort(const GlassBlockShort&) = delete;
	GlassBlockShort& operator=(const GlassBlockShort&) = delete;
