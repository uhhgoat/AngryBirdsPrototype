...
CompoundBlock::CompoundBlock(float x, float y, float rot, b2World &world, bool showDebugShape)
{
	// Glass Block 1
	GraphicsObject_Sprite* pGraphics_Sprite = new GraphicsObject_Sprite(ImageName::GlassBlockMed, Rect(x, y, 400, 40));
	GameObject2D* pGlassBlock = new GameObject2D(GameObjectName::GlassBlockMed, pGraphics_Sprite, GameObject2D::Box);
	...
	GameObject2D* pGlassBlock2 = new GameObject2D(GameObjectName::GlassBlockMed, pGraphics_Sprite, GameObject2D::Box);
	...
	GameObject2D* pGlassBlock3 = new GameObject2D(GameObjectName::GlassBlockMed, pGraphics_Sprite, GameObject2D::Box);
	...
	// Glass Block 4
	pGraphics_Sprite = new GraphicsObject_Sprite(ImageName::GlassBlockMed, Rect(x, y, 400, 40));
	GameObject2D* pGlassBlock4 = new GameObject2D(GameObjectName::GlassBlockMed, pGraphics_Sprite, GameObject2D::Box);
	...
	b2Body *pGlassBlockBody = world.CreateBody(&GlassBlockDef);
	...
	GlassBlockFixtureDef.filter.categoryBits = FilterCategory::GLASSBLOCK;
	GlassBlockFixtureDef.filter.maskBits = FilterCategory::BIRD | FilterCategory::PIG | FilterCategory::WOODBLOCK | FilterCategory::GLASSBLOCK;
	...
	GlassBlock2FixtureDef.filter.categoryBits = FilterCategory::GLASSBLOCK;
	GlassBlock2FixtureDef.filter.maskBits = FilterCategory::BIRD | FilterCategory::PIG | FilterCategory::WOODBLOCK | FilterCategory::GLASSBLOCK;
	...
	GlassBlock3FixtureDef.filter.categoryBits = FilterCategory::GLASSBLOCK;
	GlassBlock3FixtureDef.filter.maskBits = FilterCategory::BIRD | FilterCategory::PIG | FilterCategory::WOODBLOCK | FilterCategory::GLASSBLOCK;
	...
	GlassBlock4FixtureDef.filter.categoryBits = FilterCategory::GLASSBLOCK;
	GlassBlock4FixtureDef.filter.maskBits = FilterCategory::BIRD | FilterCategory::PIG | FilterCategory::WOODBLOCK | FilterCategory::GLASSBLOCK;
