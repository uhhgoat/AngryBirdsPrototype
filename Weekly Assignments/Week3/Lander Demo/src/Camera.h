...
public:
   ...
   // Get the matrices for rendering
	...
	float getMinX()  const { return xMin; }
	float getMaxX()  const { return xMax; }
	float getMinY()  const { return yMin; }
	float getMaxY()  const { return yMax; }
	float getMinZ()  const { return zMin; }
	float getMaxZ()  const { return zMax; }
