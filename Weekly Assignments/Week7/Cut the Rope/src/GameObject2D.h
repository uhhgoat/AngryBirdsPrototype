...
public:
	...
	virtual void CollideVisit(BlockWoodLong&, b2Contact*, const b2ContactImpulse*) { DebugMsg::out("GameObject2D hit BlockWoodLong\n"); };
	virtual void CollideVisit(RedBird&, b2Contact*, const b2ContactImpulse*) { DebugMsg::out("GameObject2D hit Redbird\n"); };
	virtual void CollideVisit(GenericBlock&, b2Contact*, const b2ContactImpulse*) { DebugMsg::out("GameObject2D hit GenericBlock\n"); };
	virtual void CollideVisit(Pig&, b2Contact*, const b2ContactImpulse*) { DebugMsg::out("GameObject2D hit Pig\n"); };
	virtual void CollideVisit(StickWood&, b2Contact*, const b2ContactImpulse*) { DebugMsg::out("GameObject2D hit StickWood\n"); };
	virtual void CollideVisit(Gear&, b2Contact*, const b2ContactImpulse*) { DebugMsg::out("GameObject2D hit Gear\n"); };
	virtual void CollideVisit(YellowBird&, b2Contact*, const b2ContactImpulse*) { DebugMsg::out("GameObject2D hit YellowBird\n"); };
...
public: // Should be protected and with accessors
	...
	virtual b2RevoluteJoint* GetJoint() { return nullptr; };
	virtual void SetJoint(b2RevoluteJoint* joint) { joint; };
