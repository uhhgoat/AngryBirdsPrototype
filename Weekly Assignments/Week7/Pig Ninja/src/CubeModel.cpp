...
void CubeModel::privCreateVAO( const char * const modelFileName )
{
    ...
    // Load the combined data: ---------------------------------------------------------
		...
		glBufferData(GL_ARRAY_BUFFER, (int)sizeof(Vert_xyzuvn) * this->numVerts, cubeData, GL_STATIC_DRAW);
	  ...
	  // Load the index data: ---------------------------------------------------------
            ...
            /* Bind our 2nd VBO as being the active buffer and storing index ) */
	         ...
	         /* Copy the index data to our buffer */
		      glBufferData(GL_ELEMENT_ARRAY_BUFFER, (int)sizeof(Tri_index) * this->numTris, triList, GL_STATIC_DRAW);
