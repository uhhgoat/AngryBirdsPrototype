...
private:
	...
	void privAddMarkerWorld(b2Vec2 pos, Color::Type c, float size);
...
public:
	...
	static void AddMarkerWorld(b2Vec2 pos, Color::Type c = Color::Type::Red, float size = .05f) { Instance().privAddMarkerWorld(pos, c, size); }
};
