...
void Game::LoadContent()
{
	...
	//carCasual = new CarCasual(-3000, 600);
	//autoCam = new AutoCam(carCasual->getBody(), carCasual->getBody());
	
	//carOffRoad = new CarOffroad(-3000, 600);

	hC = new Hovercraft(-3000, 600);
	GameObjectMan::Add(hC, GameObjectName::MainGroup);

	autoCam = new AutoCam(hC, hC);
