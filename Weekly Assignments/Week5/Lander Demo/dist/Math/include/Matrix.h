...
public:
	...
	Matrix( MatrixTransType , const float tx, const float ty, const float tz );
	Matrix( MatrixScaleType , const float sx, const float sy, const float sz);
	...
	void set( MatrixScaleType , const float sx, const float sy, const float sz );
