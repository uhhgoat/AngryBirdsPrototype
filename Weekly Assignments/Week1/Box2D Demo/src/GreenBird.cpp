...
GreenBird::GreenBird(float x, float y, float rot, b2World &world)
...
GreenBird::GreenBird(float x, float y, float rot, bool showDebugShape, b2World &world)
	:GameObject2D(GameObjectName::GreenBird)
{
	//AZUL STUFF
	GraphicsObject_Sprite *pGraphics_Sprite = new GraphicsObject_Sprite(ImageName::GreenBird, Rect(x, y, 175, 140));
