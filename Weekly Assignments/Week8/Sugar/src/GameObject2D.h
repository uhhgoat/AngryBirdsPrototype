...
public:
	...
	virtual void CollideVisit(TrailPuff&, b2Contact*, const b2ContactImpulse*) {  };
	virtual void CollideVisit(FeatherYellow&, b2Contact*, const b2ContactImpulse*) {  };
	virtual void CollideVisit(Shrapnel&, b2Contact*, const b2ContactImpulse*) {  };
	virtual void CollideVisit(ColorFilter&, b2Contact*, const b2ContactImpulse*) {  };
